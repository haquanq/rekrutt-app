...
class RecruitmentApplicationStoreRequest extends BaseRecruitmentApplicationRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            $candidateAlreadyApplied = RecruitmentApplication::query()
                ->where("candidate_id", $this->input("candidate_id"))
                ->where("recruitment_id", $this->input("recruitment_id"))
                ->exists();

            if ($candidateAlreadyApplied) {
                $validator->errors()->add("candidate_id", "Candidate is already applied to this recruitment.");
            }
        });
    }
